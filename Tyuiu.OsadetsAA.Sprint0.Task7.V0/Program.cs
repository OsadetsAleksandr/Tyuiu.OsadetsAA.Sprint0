...
using Tyuiu.OsadetsAA.Sprint0.Task7.V0.Lib;
namespace Tyuiu.OsadetsAA.Sprint0.Task7.V0
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("***************************************************************************");
            if (arrayNums1.Length == arrrayNums2.Length)
            {
                int[] resultArray = DataService.AdditionArrays(arrayNums1, arrrayNums2 );
